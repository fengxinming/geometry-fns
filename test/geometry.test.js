...
import orthocenterOf from '../src/orthocenterOf';
...
describe('测试几何图形公式', () => {
  ...
  it('求多边形的重心坐标', () => {
    expect(orthocenterOf([381, 216, 211, 216, 211, 124, 381, 124])).toEqual([296, 170]);
    expect(orthocenterOf([])).toEqual(null);
    expect(orthocenterOf([1, 1, 2, 2])).toEqual([1.5, 1.5]);
    expect(orthocenterOf([154, 97, 341, 95, 255, 240])).toEqual([250, 144]);
  });
